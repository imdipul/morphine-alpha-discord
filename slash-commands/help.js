		...
		if (optioninvalid) {
            ...
            **Description:**\n\`\`\`${
			...
			const embed = new Discord.MessageEmbed()
				...
				.setColor("GREEN")
				.setDescription(
					`**My prefix:** \`${prefixesdatabase.prefix}\` , Traditional Command List for \`${prefixesdatabase.prefix}help\`\nClick [HERE](https://discord.com/oauth2/authorize?client_id=722349747867746314&permissions=485846102&scope=applications.commands%20bot) to invite me to your server.\n\n\`avatar\`, \`cat\`, \`dog\`, \`enlarge\`, \`help\`, \`meme\`, \`ping\`, \`snipe\`, \`uptime\`, \`weather\``
				)
				.setFooter(`© ${nowyear} ${client.user.username}`);
